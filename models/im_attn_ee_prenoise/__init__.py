import models.im_attn_ee.editor as base_ee
...
from models.im_attn_ee_prenoise.edit_encoder import attn_encoder
from models.im_vev.input import read_examples_from_file

NAME = 'im_attn_ee_prenoise'

base_ee.attn_encoder = attn_encoder
