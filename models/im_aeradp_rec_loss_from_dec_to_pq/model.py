...
from models.im_pg_rec_loss_from_dec.model import add_extra_summary, get_extra_summary_logger
...
from models.im_aeradp_rec_loss_from_dec_to_pq import editor
...
def model_fn(features, mode, config, embedding_matrix, vocab_tables):
    ...
    gold_dec_out, gold_dec_out_len = editor.editor_train(
        ...
        config.editor.reconstruction, config.editor.recons_temp.starter,
        config.editor.recons_temp.decay_rate, config.editor.recons_temp.decay_steps,
