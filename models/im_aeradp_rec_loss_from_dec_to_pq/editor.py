...
from models.im_aeradp_rec_loss_from_dec_to_pq import reconstruction
...
def editor_train(base_words, extended_base_words, output_words, extended_output_words,
                 ...
                 recons, temper_starter, temper_decay_rate, temper_decay_steps,
    ...
    if kill_edit:
        ...
        if draw_edit:
            ...
            edit_vector, wa_inserted, wa_deleted = attn_encoder(
                ...
                iw_len, dw_len,
                ctx_hidden_dim, ctx_hidden_layer, wa_hidden_dim, wa_hidden_layer, meve_hidden_dim, meve_hidden_layers,
                edit_dim, micro_edit_ev_dim, num_heads, lamb_reg, norm_eps, norm_max,
                use_dropout=use_dropout, dropout_keep=dropout_keep, swap_memory=swap_memory,
    ...
    reconstruction_loss = reconstruction.decoder_outputs_to_pq(
        train_decoder, base_sent_embed, source_words, target_words,
        src_len, tgt_len, temper_starter, temper_decay_rate, temper_decay_steps,
        recons.agenda, recons.encoder.hidden, recons.encoder.layers,
        recons.decoder.hidden, recons.decoder.layers, swap_memory,
