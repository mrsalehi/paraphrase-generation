...
from models.im_aeradp_rec_loss_from_dec_hid_to_pq import reconstruction
...
def editor_train(base_words, extended_base_words, output_words, extended_output_words,
    ...
    reconstruction_loss = reconstruction.decoder_hiddens_to_pq(
        train_decoder, base_sent_embed, source_words, target_words,
        src_len, tgt_len,
        recons.agenda, recons.decoder.hidden, recons.decoder.layers, swap_memory,
