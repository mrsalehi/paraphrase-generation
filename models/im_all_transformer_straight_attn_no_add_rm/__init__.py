...
from models.im_all_transformer_straight_attn_no_add_rm.edit_encoder import EditEncoder

NAME = 'im_all_transformer_straight_attn_no_add_rm'

# Patch new EditEncoder
base_editor.EditEncoder = EditEncoder
