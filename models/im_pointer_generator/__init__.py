...
from models.im_pointer_generator.decoder import create_decoder_cell
from models.im_pointer_generator.input import read_examples_from_file, input_fn, input_fn_from_gen_multi
from models.im_pointer_generator.model import model_fn
from models.im_pointer_generator.optimizer import loss

NAME = 'im_pointer_generator'
