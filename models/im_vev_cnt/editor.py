...
from models.im_ev_attn.edit_encoder import rnn_encoder
from models.im_cnct_agn import agenda as agn
...
def editor_train(base_words, output_words, source_words, target_words, insert_words, delete_words,
    ...
    if kill_edit:
        ...
        if draw_edit:
            ...
            edit_vector, wa_inserted, wa_deleted = rnn_encoder(
    ...
    # [batch x agenda_dim]
    input_agenda = agn.concat(base_sent_embed, edit_vector, agenda_dim)
