...
from models.neural_editor.edit_encoder import random_noise_encoder, accumulator_encoder
...
def editor_train(base_words, extended_base_words, output_words, extended_output_words,
                 ...
                 recons_dense_layers, temper_starter, temper_decay_rate, temper_decay_steps,
    ...
    if kill_edit:
        ...
        if draw_edit:
            ...
            edit_vector = accumulator_encoder(
                insert_word_embeds,
                delete_word_embeds,
                iw_len,
                dw_len,
            ...
            wa_inserted, wa_deleted = (tf.constant([[0]]), tf.constant([[0]])), (tf.constant([[0]]), tf.constant([[0]]))
    ...
    edit_vector_recons = reconstruction.decoder_outputs_to_edit_vector(
        train_decoder, temper_starter, temper_decay_rate, temper_decay_steps,
        edit_dim, ctx_hidden_dim, ctx_hidden_layer, recons_dense_layers, swap_memory
    )
